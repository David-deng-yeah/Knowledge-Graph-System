use dba;
drop table IF EXISTS dba.dba_rpt_risk2000entry;
CREATE TABLE `dba_rpt_risk2000entry` (
  `yyyy` date NOT NULL,
...
load data local infile 'dba_rpt_risk2000entry.tmp'
replace into table dba.dba_rpt_risk2000entry
