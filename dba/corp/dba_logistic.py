...
sql = """
select `LOGISTICS_CODE` AS `CODE`,`LOGISTICS_NAME` AS `NAME`,'LOG_I' as SRC from app_db_cbec_zs.cbec_elist where LOGISTICS_NAME is not null group by LOGISTICS_CODE,LOGISTICS_NAME
UNION
select `LOGISTICS_CODE` AS `CODE`,`LOGISTICS_NAME` AS `NAME`,'LOG_E' as SRC from app_db_cbee_zs.cbee_elist where LOGISTICS_NAME is not null group by LOGISTICS_CODE,LOGISTICS_NAME
"""
import pandas as pd
