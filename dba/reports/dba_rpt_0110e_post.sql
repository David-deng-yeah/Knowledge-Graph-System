-- rank by country
DROP TABLE IF EXISTS dba_rpt_0110e_cty;
CREATE TABLE dba_rpt_0110e_cty
...
ALTER TABLE dba_rpt_0110e_cty ADD INDEX idx_yyyymm_cty (`年月`,`国家`);

-- rank by country/code4
DROP TABLE IF EXISTS dba_rpt_0110e_code4;
CREATE TABLE dba_rpt_0110e_code4
...
ALTER TABLE dba_rpt_0110e_code4 ADD INDEX idx_yyyymm_cty (`年月`,`国家`);

-- rank by country/code
DROP TABLE IF EXISTS dba_rpt_0110e_code;
CREATE TABLE dba_rpt_0110e_code
SELECT v2.*,IF(@p =CONCAT(`年月`,`国家`),@rk :=@rk+1,IF(@p :=CONCAT(`年月`,`国家`),@rk:=1,0)) g_rank FROM
(
...
ALTER TABLE dba_rpt_0110e_code ADD INDEX idx_yyyymm_cty (`年月`,`国家`);
